...
// last array). Even though it is the last bus stop, the bus is not empty and some people are still in
...
function peopleOnTheBus(arrayOfStops) {
    let people = 0;
    arrayOfStops.forEach(busStop => {
        people += busStop.getOn;
        people -= busStop.getOff;
    });
    return people;
}
